...
filename = "18N_online_points_unconvoluted.csv"
...
spline = make_interp_spline(x_sorted, y_sorted, k=1)  # k=3 for cubic spline
...
root_file = TFile('18N_RMATRIX.root', 'RECREATE')
