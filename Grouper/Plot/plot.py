...
Display(histo, xlim=(3280, 3380), ylim=(1, 10e3), title = "", ax = ax, lw = 0.4, ylabel = "Counts / 0.5 keV")
plt.subplots_adjust(left=0.25, right=0.9, top=0.9, bottom=0.2)
plt.savefig("D5.1_IAS_exp.png", dpi = 300)

fig, ax = plt.subplots(figsize = (6, 4))
file = TFile(dir + "runs_32Ar_merged.root", "READ")
histo = file.Get("Silicon_Calibrated/Hist/D5.1")
Display(histo, xlim=(3280, 3380), ylim=(1, 7e3), title = "", ax = ax, lw = 0.4, ylabel = "Counts / 0.5 keV")
plt.subplots_adjust(left=0.25, right=0.9, top=0.9, bottom=0.2)
...
histo_m1_single = histo_m1.Clone()
histo_m1_single.Add(histo_m1no, 1)

DisplayTH1D(histo_m1no, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.4, color = "blue", label = "1Down", rebin=5)
DisplayTH1D(histo_m1, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.4, color = "red", label = "1Down", rebin=5)
DisplayTH1D(histo_m1_single, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.4, color = "black", label = "1Down", rebin=5)
...
histo_0_single = histo_0.Clone()
histo_0_single.Add(histo_0no, 1)

DisplayTH1D(histo_0_single, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.4, color = "black", label = "1Down", rebin=5)
DisplayTH1D(histo_0no, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.4, color = "blue", label = "1Down", rebin=5)
...
histo_1_single = histo_1.Clone()
histo_1_single.Add(histo_1no, 1)
DisplayTH1D(histo_1no, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.4, color = "blue", label = "1Down", rebin=5)
DisplayTH1D(histo_1, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.4, color = "red", label = "1Down", rebin=5)
DisplayTH1D(histo_1_single, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.4, color = "black", label = "1Down", rebin=5)
ax.set_xlabel("Energy [keV]")


ax.set_ylabel("Counts / 0.5 keV")
plt.subplots_adjust(left=0.2, right=0.9, top=0.9, bottom=0.2)
plt.savefig("Ar_a1_coincsingle.png", dpi = 300)
