...
histo_1_sub = histo_1.Clone()
histo_1_sub.Add(histo_1no, -1)
#DisplayTH1D(histo_1_sub, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.8, color = "blue", label = "1Down", rebin=5)
DisplayTH1D(histo_1, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.8, color = "red", label = "1Down", rebin=5)
DisplayTH1D(histo_1no, xlim=xlim, ylim=ylim, title = "", ax = ax, lw = 0.8, color = "black", label = "1Down", rebin=5)
ax.set_xlabel("Energy [keV]")
