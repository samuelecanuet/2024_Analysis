...
inline void InitDetectors(const string &fname)
{
  ...
  if (FLAG2025)
  {
    ...
    DIR_ROOT_DATA_RESULTS = "/mnt/hgfs/shared-2/2025_DATA/DETECTOR_DATA/RESULTS/";
  ...
  else if (FLAG2024)
  {
    ...
    DIR_ROOT_DATA_RESULTS = "/mnt/hgfs/shared-2/2024_DATA/DETECTOR_DATA/RESULTS/";
