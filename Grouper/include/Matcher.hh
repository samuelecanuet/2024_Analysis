...
int SiPM_saturation[BETA_SIZE+1] = {0, 200000, 200000, 200000, 200000, 200000, 150000, 200000, 200000, 200000};
double SiPM_gain[BETA_SIZE+1] = {0, 1, 1, 7/10,  7/10, 1, 1,  7/10,  7/10, 1};
...
// {
//     if (cEntry % 100000 == 0 && cEntry > 20000)
//         {
//             Current = clock();
//             const Char_t *Color;
...
inline int InitHistograms()
{
    ...
    {
            HSiPMHigh_Channel[i] = new TH1D(("HSiPMHigh_" + to_string(i) + "_Channel").c_str(), ("HSiPMHigh_" + to_string(i) + "hannel").c_str(), eLowN, eLowMin, eLowMax);
            ...
            HSiPMHigh_Channel_all[i] = new TH1D(("HSiPMHigh_all_" + to_string(i) + "_Channel").c_str(), ("HSiPMHigh_all_" + to_string(i) + "hannel").c_str(), eLowN, eLowMin, eLowMax);
            ...
            HSiPMLow_Channel[i] = new TH1D(("HSiPMLow_" + to_string(i) + "_Channel").c_str(), ("HSiPMLow_" + to_string(i) + "hannel").c_str(), eLowN, eLowMin, eLowMax);
            ...
            HSiPMLow_Channel_all[i] = new TH1D(("HSiPMLow_all_" + to_string(i) + "_Channel").c_str(), ("HSiPMLow_all_" + to_string(i) + "hannel").c_str(), eLowN, eLowMin, eLowMax);
            ...
            HSiPM_Channel[i] = new TH1D(("HSiPM_" + to_string(i) + "_Channel").c_str(), ("HSiPM_" + to_string(i) + "hannel").c_str(), eLowN, eLowMin, eLowMax);
    ...
    HSiPM = new TH1D("HSiPM", "HSiPM", eLowN, eLowMin, eLowMax);
    HSiPM->GetXaxis()->SetTitle("SiPM [Channel]");
    HSiPM->GetYaxis()->SetTitle("Counts");
    HSiPM->GetXaxis()->CenterTitle();
    HSiPM->GetYaxis()->CenterTitle();
    
    HSiPMHigh_False = new TH1D("HSiPMHigh_False", "HSiPMHigh_False", eLowN, eLowMin, eLowMax);
