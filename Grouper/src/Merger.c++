...
int main(int argc, char *argv[])
{
    ...
    InitFiles();
    string dir = "../../../../../run/media/local1/Disque_Dur/Grouper/";
    string dirNameMerged = dir+"./Merged/";
    string dirNameCleaned = dir+"./Cleaned/";
    string dirNameMatched = dir+"./Matched/";
    ...
    for (auto &run : runs)
    {
        ...
        Matched_File = new TFile((dirNameMatched + "run_" + run_string + "_multifast_32Ar_matched.root").c_str(), "READ");
    ...
    {if (run < 100)
        ...
        {   
            ...
            for (int sipm = 0; sipm < Tree_SiPM.GetSize(); sipm++)
            {
                if (IsDetectorBetaHigh(Tree_SiPM[sipm].Label))
                {
                    multiplicity++;
                }
            }
