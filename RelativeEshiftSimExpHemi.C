...
int RelativeEshiftSimExpHemi()
{
    ...
    for (int i = 0; i < G_Exp_Eshift->GetN(); i++)
    {
        ...
        mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] += G_Exp_Eshift->GetY()[i];
        mean_exp_strip_err[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] += pow(G_Exp_Eshift->GetErrorY(i), 2);
    }
    ...
    for (int i = 0; i < G_Sim_Eshift1->GetN(); i++)
    {
        ...
        mean_sim1_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] += G_Sim_Eshift1->GetY()[i];
        mean_sim1_strip_err[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] += pow(G_Sim_Eshift1->GetErrorY(i), 2);
    }
    ...
    for (int i = 0; i < G_Sim_Eshift1->GetN(); i++)
    {
        ...
        double relative_y = (y);// - (mean_sim1_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] - mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)]));
        double relative_err_y = sqrt( pow(err_y / mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)], 2) + pow(mean_sim1_strip_err[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * y / (mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)]), 2) + pow(mean_exp_strip_err[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * y / (mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)]), 2) + pow(err_mean_sim1 / mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)], 2) + pow(err_mean_exp * y / (mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)]), 2) ) ;
    ...
    for (int i = 0; i < G_Sim_Eshift07->GetN(); i++)
    {
        ...
        mean_sim07_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] += G_Sim_Eshift07->GetY()[i];
        mean_sim07_strip_err[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] += pow(G_Sim_Eshift07->GetErrorY(i), 2);
    }
    ...
    for (int i = 0; i < G_Sim_Eshift07->GetN(); i++)
    {
        ...
        // double exp_y = G_Exp_Eshift->GetY()[i];
        // double err_exp_y = G_Exp_Eshift->GetErrorY(i);  
        double relative_y = (y);// - (mean_sim07_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] - mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)]));
        double relative_err_y = sqrt( pow(err_y / mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)], 2) + pow(mean_sim07_strip_err[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * y / (mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)]), 2) + pow(mean_exp_strip_err[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * y / (mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)]), 2) + pow(err_mean_sim07 / mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)], 2) + pow(err_mean_exp * y / (mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)] * mean_exp_strip[x < 50 ? GetDetectorChannel(x) : 10 + GetDetectorChannel(x)]), 2) ) ;
